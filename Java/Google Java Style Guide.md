...
[google.github.io](https://google.github.io/styleguide/javaguide.html#s3.4.1-one-top-level-class)
...
The source file name consists of the case-sensitive name of the top-level class it contains (of which there is [exactly one](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s3.4.1-one-top-level-class)), plus the `.java` extension.
...
The package statement is **not line-wrapped**. The column limit (Section 4.4, [Column limit: 100](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s4.4-column-limit)) does not apply to package statements.
...
Import statements are **not line-wrapped**. The column limit (Section 4.4, [Column limit: 100](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s4.4-column-limit)) does not apply to import statements.
...
**Terminology Note:** _block-like construct_ refers to the body of a class, method or constructor. Note that, by Section 4.8.3.1 on [array initializers](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s4.8.3.1-array-initializers), any array initializer _may_ optionally be treated as if it were a block-like construct.
...
Java code has a column limit of 100 characters. A "character" means any Unicode code point. Except as noted below, any line that would exceed this limit must be line-wrapped, as explained in Section 4.5, [Line-wrapping](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s4.5-line-wrapping).
...
2. `package` and `import` statements (see Sections 3.2 [Package statement](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s3.2-package-statement) and 3.3 [Import statements](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s3.3-import-statements)).
...
Section 4.6.3 on [Horizontal alignment](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s4.6.3-horizontal-alignment) addresses the discouraged practice of using a variable number of spaces to align certain tokens with previous lines.
...
1. _Between_ consecutive members or initializers of a class: fields, constructors, methods, nested classes, static initializers, and instance initializers.
    ...
    - **Exception:** Blank lines between enum constants are covered in [Section 4.8.1](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s4.8.1-enum-classes).
2. As required by other sections of this document (such as Section 3, [Source file structure](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s3-source-file-structure), and Section 3.3, [Import statements](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s3.3-import-statements)).
...
Annotations applying to a class appear immediately after the documentation block, and each annotation is listed on a line of its own (that is, one annotation per line). These line breaks do not constitute line-wrapping (Section 4.5, [Line-wrapping](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s4.5-line-wrapping)), so the indentation level is not increased. Example:
...
The rules for annotations on method and constructor declarations are the same as the [previous section](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s4.8.5.2-class-annotation-style). Example:
...
This section addresses _implementation comments_. Javadoc is addressed separately in Section 7, [Javadoc](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s7-javadoc).
...
Class names are written in [UpperCamelCase](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s5.3-camel-case).
...
Method names are written in [lowerCamelCase](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s5.3-camel-case).

Method names are typically verbs or verb phrases. For example, `sendMessage` or `stop`.

Underscores may appear in JUnit _test_ method names to separate logical components of the name, with _each_ component written in [lowerCamelCase](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s5.3-camel-case), for example `transferMoney_deductsFromSource`. There is no One Correct Way to name test methods.
...
Non-constant field names (static or otherwise) are written in [lowerCamelCase](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s5.3-camel-case).

These names are typically nouns or noun phrases. For example, `computedValues` or `index`.

#### 5.2.6 Parameter names

Parameter names are written in [lowerCamelCase](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s5.3-camel-case).

One-character parameter names in public methods should be avoided.

#### 5.2.7 Local variable names

Local variable names are written in [lowerCamelCase](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s5.3-camel-case).
...
- A name in the form used for classes (see Section 5.2.2, [Class names](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s5.2.2-class-names)), followed by the capital letter `T` (examples: `RequestT`, `FooBarT`).
...
Additional Javadoc content may also be present, as explained in Section 7.3.4, [Non-required Javadoc](about:reader?url=https%3A%2F%2Fgoogle.github.io%2Fstyleguide%2Fjavaguide.html#s7.3.4-javadoc-non-required).
